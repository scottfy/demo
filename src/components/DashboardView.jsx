    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/20 text-blue-300 text-xs font-bold border border-blue-400/30">
              <Sparkles className="w-3.5 h-3.5 text-blue-400" /> AI 智慧採購比價助手 2.0
            </span>
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white">
              輕鬆完成採購比價、策略擬定與 HTML5 報告繪製
            </h2>
            <p className="text-slate-300 text-sm leading-relaxed">
              透過 AI 自動在 Google, 1688, Amazon, 蝦皮, PCHome 等平台搜尋 20~50 項候選方案，進行規格對齊、總成本試算與供應商可信度評估。
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xs text-slate-500 font-semibold">已完成比價報告</div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xs text-slate-500 font-semibold">預估節省總額</div>
            <div className="text-2xl font-black text-emerald-600">TWD $340,000+</div>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-2xl font-black text-slate-900">22 項 / 案</div>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xs text-slate-500 font-semibold">平均可信度評分</div>
            <div className="text-2xl font-black text-slate-900">96 分</div>
          </div>
        </div>
      </div>

      {/* Recent Reports Document Cards Grid Section */}
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 space-y-1.5">
                  ...
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-500">候選調查廠商:</span>
                    <span className="font-medium text-slate-700">{report.itemCount || 20} 家</span>
                  </div>
                </div>
              </div>
